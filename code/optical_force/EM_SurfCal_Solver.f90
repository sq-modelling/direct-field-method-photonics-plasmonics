...
! The optical-force driver also uses the electric- and magnetic-dipole source
! terms assembled in the two field-specific solve routines.
...
!$OMP END PARALLEL
    ...
    SUBROUTINE SlvPrblm_EM_Esc
        ...
        COMPLEX(KIND=KIND(1.0D0)) :: ztpeps,ztpmiu,ztpk,ztpexp,ztp1x,ztp1y,ztp1z
        DOUBLE PRECISION :: tpx,tpy,tpz,tpr,tpxhat,tpyhat,tpzhat, &
        ...
        DO ithprtl = 1, nmbrprtl
            ...
            IF (BCType_EM(ithprtl) == '2SD') THEN
                ...
                ! CALL Get_DEL_DivFrsc_dt(ithprtl, 'E')
        ...
        !$OMP & PRIVATE (tp,tp1,tp2,tp3,ztp,ztp1,ztp2,ztp3,ztp4,ztp5,ztp6,ztp7,ztp8,ztp9,mdm_oi,mdm_io) &
        !$OMP & PRIVATE (ztpeps,ztpmiu,ztpk,tpx,tpy,tpz,tpr,tpxhat,tpyhat,tpzhat) &
        !$OMP & PRIVATE (rhat_dot_p,rhat_crs_p_x,rhat_crs_p_y,rhat_crs_p_z,ztpexp,ztp1x,ztp1y,ztp1z)
        !$OMP DO
        DO i = 1, ttlnmbrnd
                ...
                IF (srcendID_EM(id_tp) > 0) THEN
                    ...
                    DO kk = ii, jj
                        ...
                        IF (srcType_EM(kk) == 2) THEN       !dynamic electric dipole
                            ...
                            ztp4 = ztp4/(vcm_eps0*ztpeps)
                            ztp5 = ztp5/(vcm_eps0*ztpeps)
                            ...
                            IF (NrmlInOut(ithprtl) == 1) THEN
                                ...
                                bimBB(mtidst(i)  ) = bimBB(mtidst(i)  ) + ztp1x
                                bimBB(mtidst(i)+1) = bimBB(mtidst(i)+1) + ztp1y
                                bimBB(mtidst(i)+2) = bimBB(mtidst(i)+2) + ztp1z
                    ...
                    DO kk = ii, jj
                        ...
                        IF (srcType_EM(kk) == 2) THEN       !dynamic electric dipole
                            ...
                            IF (NrmlInOut(ithprtl) == 1) THEN
                                ...
                                bimBB(mtidst(i)+3) = bimBB(mtidst(i)+3) - ztp1x
                                bimBB(mtidst(i)+4) = bimBB(mtidst(i)+4) - ztp1y
                                bimBB(mtidst(i)+5) = bimBB(mtidst(i)+5) - ztp1z
                            ...
                            DO kk = ii, jj
                                ...
                                IF (srcType_EM(kk) == 2) THEN       !dynamic electric dipole
                                    ...
                                    IF (NrmlInOut(ithprtl) == 1) THEN
                                        ...
                                        IF (icmpt == 1) bimBB(mtidst(i)  ) = bimBB(mtidst(i)  ) + ztp1x
                                        IF (icmpt == 2) bimBB(mtidst(i)  ) = bimBB(mtidst(i)  ) + ztp1y
                                        IF (icmpt == 3) bimBB(mtidst(i)  ) = bimBB(mtidst(i)  ) + ztp1z
    ...
    SUBROUTINE SlvPrblm_EM_Hsc
        ...
        DO ithprtl = 1, nmbrprtl
            ...
            IF (BCType_EM(ithprtl) == '2SD') THEN
                ...
                ! CALL Get_DEL_DivFrsc_dt(ithprtl, 'H')
